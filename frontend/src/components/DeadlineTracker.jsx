...
export default function DeadlineTracker({ deadlines, setDeadlines }) {
  ...
  return (
    <div className="page-grid deadline-page grid grid-cols-1 lg:grid-cols-3 gap-6 animate-fade-in">
          ...
          {filteredDeadlines.length === 0 ? (
            ...
            filteredDeadlines.map(item => {
              ...
              return (
                <div 
                  key={item.id} 
                    className={`glass-card p-4 border transition-all duration-300 flex flex-col md:flex-row md:items-center justify-between gap-4 float-card
