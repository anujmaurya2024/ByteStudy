  ...
  return (
    <div className="mt-4">
      ...
      <div className="w-full bg-slate-100 dark:bg-surface-600 rounded-full h-4 overflow-hidden">
        <div
          className={`required-sgpa-fill h-4 rounded-full transition-all duration-700 ${!isValid ? 'required-sgpa-fill-invalid' : ''}`}
...
export default function PredictorPanel({
  ...
  return (
    <div className="page-stack predictor-page animate-fade-in">
