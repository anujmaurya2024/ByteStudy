...
public class AccountSecurityController {
 ...
 @PostMapping("/verify-email") public ResponseEntity<Void> verify(@RequestBody Map<String,String> b){email.verify(b.getOrDefault("token",""));return ResponseEntity.noContent().build();}
